...
const Juttis= () => {
  ...
  const products = [
    { id: 1, src: 'https://leadwalkshop.com/wp-content/uploads/2023/06/z.jpeg', name: 'NOORAH ', price: '$300' },
    { id: 2, src: 'https://leadwalkshop.com/wp-content/uploads/2024/02/WhatsApp-Image-2024-02-07-at-4.58.02-PM.jpeg', name: 'SILAH', price: '$400' },
    { id: 3, src: 'https://leadwalkshop.com/wp-content/uploads/2023/06/s.jpeg', name: 'NAYAB ', price: '$200' },
    { id: 4, src: 'https://leadwalkshop.com/wp-content/uploads/2023/06/p.jpeg', name: 'ZIMAL ', price: '$250' },
  ...
  return (
    <div style={{ textAlign: 'center'}}>
      <h1 style={{ marginBottom: '40px', marginTop: '20px',fontSize:'35px',color:'grey' }}>JUTTIS</h1>
